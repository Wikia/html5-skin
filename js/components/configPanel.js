    ...
    render: function() {
			...
			var autoPlayText = Utils.getLocalizedString(this.props.language, CONSTANTS.SKIN_TEXT.AUTOPLAY_VIDEOS, this.props.localizableStrings);
                ...
                <div className="oo-config-panel">
                        <ul>
                            <li><a onClick={this.handleVideoQualityClick}>{videoQualityText} <svg className="oo-chevron" width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
